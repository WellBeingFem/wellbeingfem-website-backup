        ...
        <div className="page-main__inner guided-meditations-page__inner">
          <article className="guided-meditations-page__content">
            ...
            <button
              ...
              aria-controls="guided-meditations-opening-details"
              onClick={() => setOpeningExpanded((current) => !current)}
            >
              {openingExpanded ? "Less" : "More"}
            </button>
            {openingExpanded && (
              <div id="guided-meditations-opening-details" className="guided-meditations-page__disclosure">
                <p>Through imagined landscapes, archetypal symbols, evocative imagery and the creative intelligence of the imagination, each journey invites deeper awareness, reconnection with inner wisdom and discovery of aspects of the self that may have been forgotten, hidden from view or not yet fully known.</p>
